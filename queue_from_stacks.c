...
struct queue_from_stacks* queue_from_stacks_create() {
	...
	struct queue_from_stacks* temp_que = (struct queue_from_stacks*)malloc(sizeof(struct queue_from_stacks));
	temp_que->s1 = stack_create();
	temp_que->s2 = stack_create();
