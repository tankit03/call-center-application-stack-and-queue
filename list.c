...
void* get_the_top(struct list* list){
...
/******************************************************
** function void* remove_top(struct list* list);
** description: this function removes the top node rather than removing list.
** Parameters: struct list* list
** Pre-conditions: the function needs to be called in the int main.
** Post-conditions: this removes the top value.
******************************************************/
...
void* remove_top(struct list* list){
  ...
  struct node* t_node = list->head;
  void* value = t_node->val;
...
void node_remove(struct list* list, void* value){

  struct node* previous 
  struct node* current = lis
